...
class PersonTracking(object):
    ...
    def detect(self,cam_path,cam_id):
        ...
        model = DetectMultiBackend('yolov5x.pt', device=device, dnn=True)
        ...
        while True:
            ...
            for i, det in enumerate(pred):  # detections per image
                ...
                if det is not None and len(det):
                    ...
                    outputs = byteTracker.update(torch.as_tensor(np.array(pred.cpu())), img)
                            ...
                            for c_id in customers: ##### Iterating over ids present in the customer's list #####
                                if c_id not in live_id_list: ##### If that particular id is not currently in the live list/frame #####
                                    ...
                                    if time_wait_counter[c_id] >=10: ##### If counter greater than this threshold process of deleting that id #####
                                        ...
                                        del bboxes[c_id] ##### Delete bboxes for that particular id #####
                                        print(newleft)
...
if __name__ == '__main__':
    P1=PersonTracking()
    src={1:'rtsp://admin:disruptlab54321@192.168.0.6:554/stream1',2:'rtsp://admin:disruptlab54321@192.168.0.2:554/stream1'}
